...
/// Widget showing nearby salons for anonymous users (before login)
class NearbySalonsWidget extends StatelessWidget {
  const NearbySalonsWidget({super.key});
        ...
        children: [
          ...
          TextButton.icon(
            onPressed: () {
              ...
              Navigator.pushNamed(context, '/salon-map');
            },
