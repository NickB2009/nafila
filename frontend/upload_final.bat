...
echo Uploading Flutter app (final attempt)...
...
echo put AssetManifest.bin>> ftpcmd.txt
echo put AssetManifest.json>> ftpcmd.txt
echo put FontManifest.json>> ftpcmd.txt
echo cd ..>> ftpcmd.txt
echo lcd ..>> ftpcmd.txt
echo mkdir canvaskit>> ftpcmd.txt
echo cd canvaskit>> ftpcmd.txt
echo lcd canvaskit>> ftpcmd.txt
echo put canvaskit.js>> ftpcmd.txt
echo put canvaskit.wasm>> ftpcmd.txt
echo cd ..>> ftpcmd.txt
echo lcd ..>> ftpcmd.txt
echo mkdir icons>> ftpcmd.txt
echo cd icons>> ftpcmd.txt
echo lcd icons>> ftpcmd.txt
echo put Icon-192.png>> ftpcmd.txt
echo put Icon-512.png>> ftpcmd.txt
echo cd ..>> ftpcmd.txt
echo lcd ..>> ftpcmd.txt
echo pwd>> ftpcmd.txt
echo dir>> ftpcmd.txt
...
echo.
echo Files uploaded to /www/app directory
...
echo    - Directory permissions in /www/app
echo    - .htaccess configuration
echo    - mod_rewrite status
echo.
pause 