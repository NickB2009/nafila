...
public interface ILoggingService
{
    ...
    void LogApiRequest(string method, string path, string? userId = null, string? organizationId = null, string? locationId = null);
