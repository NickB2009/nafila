...
VALUES
  ...
  ('66666666-6666-6666-6666-666666666663', 'Pedro Santos', '99999999-9999-9999-9999-999999999992', 'pedro.santos@grandetech.com', '+55-11-99998-0003', NULL, 'Barber', 1, 1, 'available', NULL, 22.8, 67, 'EMP003', 'pedro.santos', '["88888888-8888-8888-8888-888888888884"]', GETDATE(), 'seed', GETDATE(), 'seed', 0),
  ('66666666-6666-6666-6666-666666666664', 'Carlos Oliveira', '99999999-9999-9999-9999-999999999993', 'carlos.oliveira@classiccuts.com', '+55-21-99998-0004', 'https://classiccuts.com/staff/carlos.jpg', 'Master Barber', 1, 1, 'available', NULL, 45.0, 234, 'EMP004', 'carlos.oliveira', '["88888888-8888-8888-8888-888888888885","88888888-8888-8888-8888-888888888886"]', GETDATE(), 'seed', GETDATE(), 'seed', 0),
  ('66666666-6666-6666-6666-666666666665', 'Roberto Lima', '99999999-9999-9999-9999-999999999993', 'roberto.lima@classiccuts.com', '+55-21-99998-0005', NULL, 'Barber', 1, 0, 'off_duty', NULL, 38.5, 145, 'EMP005', 'roberto.lima', '["88888888-8888-8888-8888-888888888886"]', GETDATE(), 'seed', GETDATE(), 'seed', 0);

PRINT 'Staff members inserted successfully.'

-- ============================================================================
-- STEP 8: INSERT SERVICES OFFERED
-- ============================================================================

PRINT 'Inserting services offered...'
...
PRINT 'Services offered inserted successfully.'

-- ============================================================================
-- STEP 9: INSERT QUEUES
-- ============================================================================

PRINT 'Inserting queues...'
...
VALUES
  ...
  ('11111111-1111-1111-1111-111111111112', '99999999-9999-9999-9999-999999999992', CAST(GETDATE() AS DATE), 1, 30, 10, GETDATE(), 'seed', GETDATE(), 'seed', 0),
  ('11111111-1111-1111-1111-111111111113', '99999999-9999-9999-9999-999999999993', CAST(GETDATE() AS DATE), 1, 20, 20, GETDATE(), 'seed', GETDATE(), 'seed', 0);

PRINT 'Queues inserted successfully.'

-- ============================================================================
-- STEP 10: INSERT QUEUE ENTRIES
-- ============================================================================

PRINT 'Inserting queue entries...'
...
VALUES
  ('22222222-2222-2222-2222-222222222221', '11111111-1111-1111-1111-111111111111', '88888888-8888-8888-8888-888888888881', 'João Silva', 1, 'Waiting', NULL, '88888888-8888-8888-8888-888888888881', 'Regular haircut', GETDATE(), NULL, NULL, NULL, NULL, GETDATE(), 'seed', GETDATE(), 'seed', 0),
  ('22222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', '88888888-8888-8888-8888-888888888882', 'Maria Santos', 2, 'Waiting', NULL, '88888888-8888-8888-8888-888888888883', 'Wash and cut', GETDATE(), NULL, NULL, NULL, NULL, GETDATE(), 'seed', GETDATE(), 'seed', 0),
  ('22222222-2222-2222-2222-222222222223', '11111111-1111-1111-1111-111111111112', '88888888-8888-8888-8888-888888888883', 'Carlos Oliveira', 1, 'CheckedIn', '66666666-6666-6666-6666-666666666663', '88888888-8888-8888-8888-888888888884', 'VIP service', DATEADD(MINUTE, -10, GETDATE()), DATEADD(MINUTE, -8, GETDATE()), DATEADD(MINUTE, -5, GETDATE()), NULL, NULL, GETDATE(), 'seed', GETDATE(), 'seed', 0),
  ('22222222-2222-2222-2222-222222222224', '11111111-1111-1111-1111-111111111113', '88888888-8888-8888-8888-888888888884', 'Ana Costa', 1, 'Waiting', NULL, '88888888-8888-8888-8888-888888888885', 'Appointment scheduled', GETDATE(), NULL, NULL, NULL, NULL, GETDATE(), 'seed', GETDATE(), 'seed', 0),
  ('22222222-2222-2222-2222-222222222225', '11111111-1111-1111-1111-111111111111', '88888888-8888-8888-8888-888888888885', 'Walk-in Customer', 3, 'Waiting', NULL, '88888888-8888-8888-8888-888888888882', 'Quick trim', GETDATE(), NULL, NULL, NULL, NULL, GETDATE(), 'seed', GETDATE(), 'seed', 0),
  ('22222222-2222-2222-2222-222222222226', '11111111-1111-1111-1111-111111111111', NULL, 'Anonymous Customer', 4, 'Called', '66666666-6666-6666-6666-666666666661', '88888888-8888-8888-8888-888888888881', 'Walk-in customer', DATEADD(MINUTE, -15, GETDATE()), DATEADD(MINUTE, -2, GETDATE()), NULL, NULL, NULL, GETDATE(), 'seed', GETDATE(), 'seed', 0),
  ('22222222-2222-2222-2222-222222222227', '11111111-1111-1111-1111-111111111112', NULL, 'Another Customer', 2, 'Completed', '66666666-6666-6666-6666-666666666663', '88888888-8888-8888-8888-888888888884', 'Completed service', DATEADD(MINUTE, -45, GETDATE()), DATEADD(MINUTE, -40, GETDATE()), DATEADD(MINUTE, -38, GETDATE()), DATEADD(MINUTE, -15, GETDATE()), NULL, GETDATE(), 'seed', GETDATE(), 'seed', 0);

PRINT 'Queue entries inserted successfully.'
...
PRINT '- 3 Locations'
PRINT '- 5 Customers'
PRINT '- 5 Staff Members'
PRINT '- 6 Services Offered'
PRINT '- 3 Queues'
PRINT '- 7 Queue Entries'

PRINT 'You can now test the API endpoints with this comprehensive test data!'
