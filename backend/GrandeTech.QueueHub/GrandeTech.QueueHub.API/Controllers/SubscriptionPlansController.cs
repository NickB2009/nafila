    ...
    public class SubscriptionPlansController : ControllerBase
    {
        ...
        public async Task<ActionResult<object>> GetSubscriptionPlan(string subscriptionPlanId, CancellationToken cancellationToken)
        {
            ...
            var result = new
            {
                ...
                MonthlyPrice = subscriptionPlan.MonthlyPrice.Amount,
                MonthlyPriceCurrency = subscriptionPlan.MonthlyPrice.Currency,
                YearlyPrice = subscriptionPlan.YearlyPrice.Amount,
                YearlyPriceCurrency = subscriptionPlan.YearlyPrice.Currency,
