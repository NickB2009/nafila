...
namespace Grande.Fila.API.Migrations
{
    ...
    [Migration("20250804012446_AddWeeklyBusinessHours")]
    partial class AddWeeklyBusinessHours
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            // // SqlServerModelBuilderExtensions.UseIdentityColumns(modelBuilder); // Commented out for MySQL migration // Commented out for MySQL migration
            ...
            modelBuilder.Entity("Grande.Fila.API.Domain.Locations.Location", b =>
                {
                    ...
                    b.OwnsOne("Grande.Fila.API.Domain.Common.ValueObjects.TimeSpanRange", "BusinessHours", b1 =>
                        {
                            b1.Property<Guid>("LocationId")
                                .HasColumnType("uniqueidentifier");
