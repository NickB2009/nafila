...
namespace GrandeTech.QueueHub.API.Domain.Notifications
{
    ...
    public class Notification : BaseEntity, IAggregateRoot
    {
            ...
            string deepLink)
        {
            ...
            var content = $"Você está na {position}ª posição na fila da {serviceProviderName}. Em breve será atendido.";
            ...
            string deepLink)
        {
            ...
            var content = $"Use o código {couponCode} para ganhar {discount}% de desconto na {serviceProviderName}. Válido até {expirationDate}.";
